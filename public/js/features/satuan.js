const menuContext = "Satuan";
const tableId = "#table-satuan";
const formId = "#form-satuan";
const indexAPI = `${site_url_api}/satuan`;
const storeAPI = `${site_url_api}/satuan/store`;
const deleteAPI = `${site_url_api}/satuan/delete`;
const updateAPI = `${site_url_api}/satuan/update`;
const allItem = new Set();

const modalId = "#modal";
const modalTitleId = "#modal-title";
const modalProceedBtnId = "#modal-proceed-btn";
const modalContainerId = "#modal-satuan";
...
$(document).ready(function () {
    ...
    tableItem.on("click", "tr", function (event) {
        ...
        if (!isClickedOnActionsButton) {
            window.location.replace(site_url + "/satuan/show/" + itemId);
        }
    });
    ...
    $(formId).append(`
        ${InputField({ title: "Satuan", name: "satuan" })}
        ${Button({
            text: "Tambah",
...
const getCurrentSatuan = (id) => {
    ...
    for (const item of allItem) {
        if (item.id == id) currentSatuan = item;
    }
