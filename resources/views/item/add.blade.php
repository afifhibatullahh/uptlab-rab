            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="formItem" action="/barang/store" method="POST">
                            {{ csrf_field() }}
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="harga" class="form-control" id="harga" placeholder="Harga Satuan">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jenis" class="form-control" id="jenis" placeholder="Jenis Barang">
                                </div>
                            </div>
                            <!-- /.card-body -->
